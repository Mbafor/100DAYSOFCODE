...
class Person:
    ...
    def display(self):
        print(self.name, self.age, self.id_number)
...
s1 = Student("Josh", 23, "21470997", "Computer Engineering", 200)
s1.add_courses("DSA")
s1.add_courses("Programming")
s1.display_courses()
s1.greet()

t1 = Teacher("Thelsa", 56, "9440", "Introduction", 12000)
t1.greet()

t1.assign_grade(s1, "A")   # Pass the student object
t1.display_grade(s1)
